...
{
    return "INSERT INTO TB_COMMANDE (com_ref, com_date_prevue, com_date_emission, com_tot_ar, com_tot_ht, com_tot_tva, com_tot_ttc) VALUES('" + this->com_ref + "','" + this->com_date_prevue + "','" + this->com_date_emission + "','" + this->com_tot_ar + "','" + this->com_tot_ht + "','" + this->com_tot_tva + "','" + this->com_tot_ttc + "');";
}
...
{
    return "UPDATE TB_COMMANDE SET com_ref = '" + this->com_ref + "', com_date_prevue = '" + this->com_date_prevue + "', com_date_emission = '" + this->com_date_emission + "', com_tot_ar = '" + this->com_tot_ar + "', com_tot_ht = '" + this->com_tot_ht + "', com_tot_tva = '" + this->com_tot_tva + "', com_tot_ttc = '" + this->com_tot_ttc + "' WHERE id_com = " + "'" + this->id_com + "'; ";
}
